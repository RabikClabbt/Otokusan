...
<header id="header">
    <div class="left">
        ...
        <div class="search-container">
            ...
            <input type="text" autocomplete="off" aria-autocomplete="list" aria-controls="react-autowhatever-1" class="search-input" placeholder="キーワードを入力" name="sname" spellcheck="false" data-ms-editor="true">
