...
echo '<div class="region">';
    echo '<div class="ho">';
        echo '<input type="image" name="ho" src="region/Hokkaido.png"  alt="ho" value="ho">';
    echo '</div>';
    echo '<div class="to">';
    echo '<input type="image" name="to" src="region/tohoku.png"  alt="to" value="to">';
    echo '</div>';
    echo '<div class="kan">';
    echo '<input type="image" name="kan" src="region/kanto.png"  alt="kan" value="kan">';
    echo '</div>';
    echo '<div class="tyu">';
    echo '<input type="image" name="tyu" src="region/tyubu.png"  alt="tyu" value="tyu">';
    echo '</div>';
    echo '<div class="kik">';
    echo '<input type="image" name="kik" src="region/kinki.png"  alt="kik" value="kik">';
    echo '</div>';
    echo '<div class="tyugo">';
    echo '<input type="image" name="tyugo" src="region/tyugoku.png"  alt="tyu" value="tyu">';
    echo '</div>';
    echo '<div class="siko">';
    echo '<input type="image" name="siko" src="region/shikoku.png"  alt="siko" value="siko">';
    echo '</div>';
    echo '<div class="kyusy">';
    echo '<input type="image" name="kyusy" src="region/kyusyu.png"  alt="kyusy" value="kyusy">';
    '</div>';
'</div>';
?>
</body>
